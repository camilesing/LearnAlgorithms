...
public class BinarySearchST<Key extends Comparable<Key>, Value> {
	...
	/**
	 * 配合put、get之类的方法： 只要给定的键存在于表中，该方法就能够精确地告诉我们到哪里去更新它的值，以及当键不在表中时将键存值到表的何处
	 * 
	 * 返回表中小于给定键的键的数量 Returns the number of keys in this symbol table strictly
	 * less than {@code key}.
	 *
	 * @param key
	 *            the key
	 ...
	 *             unless {@code k} is between 0 and <em>n</em> &minus; 1
	 */
